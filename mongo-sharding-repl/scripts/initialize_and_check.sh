...
sleep 20  # Увеличим время ожидания, чтобы контейнеры успели подняться
...
sleep 10  # Пауза для завершения инициализации конфигурационного сервера
...
sleep 10  # Пауза для завершения инициализации первого шарда
